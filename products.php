...
<body>
	...
	<div class="container">
		...
		<?php
			...
			echo '<form method="POST" action="filter_product.php"><label style="font-size:20px;padding-right:20px;">Filters</label><select name="Category" id="Category" style="height: 37px;width: 260px; text-align: center;">
			';
			...
			<?php
				...
				if ($result->num_rows > 0) 
				{
					while ($row = $result->fetch_assoc()) 
					{
					   	...
					   	{
					   		$id=$row["id"];
					    	echo '<a href="show_product.php?id='.$id.'"><button>hi</button><tr class="item"> 
